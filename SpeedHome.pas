...
procedure Register;
begin
  RegisterComponents('Aldwicks', [TSpeedHome]);
end;
...
begin
  ...
  FSvg.Svg.Source := ReplaceStr(ICON_HOME, 'circlecolor', CC_DARK);
end;

procedure TSpeedHome.SetCircleColor(const Value: TCircleColor);
var
  CColor: string;
begin
  FCircleColor := Value;
  ...
  FSvg.Svg.Source := ReplaceStr(ICON_HOME, 'circlecolor', CColor);
